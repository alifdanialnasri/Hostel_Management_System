...
if(isset($_POST['search'])){
    ...
    $query = "SELECT * from roomregistration WHERE roomname LIKE '%$searchKey%'";
}else
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-8"><h2>Registered <b>Room</b></h2></div>
                        <div class="col-sm-4">
                            <form method="POST">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                            ...
                            while($row = mysqli_fetch_assoc($result))
                            {
                                ...
                                <td>'.$roomnum.'</td>
                                <td>
                                <a href="registerview.php?viewid='.$id.'" class="view" title="view" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                                <a href="roomregisterdelete.php?deleteid='.$id.'" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                </td>
