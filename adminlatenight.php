...
if(isset($_POST['search'])){
    ...
    $query = "SELECT * from latenight WHERE latename LIKE '%$searchKey%'";
}else
$query = "select * from latenight";
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-8"><h2>Late-Night <b>Check-In</b></h2></div>
                        <div class="col-sm-4">
                        <form method="POST">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                                ...
                                while($row = mysqli_fetch_assoc($result))
                                {
                                    ...
                                    <td>'.$latereason.'</td>
                                    <td>
                                    <a href="latenightview.php?lateviewid='.$LATE_ID.'" class="view" title="view" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                                    <a href="latenightdelete.php?latedeleteid='.$LATE_ID.'" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                    </td>
